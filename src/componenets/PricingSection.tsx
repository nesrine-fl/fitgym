...
const PricingSection = ({ fullPage = false }: PricingSectionProps) => {
 ...
 const inView = useInView(ref, { once: true, margin: "-10px" }); // Smaller margin triggers earlier

  return (
   <section className={`py-24 pt-32 ${fullPage ? "bg-background" : "bg-secondary/30"}`} ref={ref}>
      <div className="container mx-auto px-4">
        ...
        >
          <span className="text-primary font-heading text-sm tracking-[0.3em]">{t.pricing.tag}</span>
